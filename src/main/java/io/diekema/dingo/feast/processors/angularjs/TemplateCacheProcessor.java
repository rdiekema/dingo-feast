...
public class TemplateCacheProcessor implements Processor{
    private static final String MODULE_TEMPLATE = "'use strict'; var %s = angular.module('%s'); %s";
    private static final String WRAPPING_FUNCTION_TEMPLATE = "%s.run(['$templateCache',function($templateCache) {%s}]);";
    ...
    public void process(Exchange exchange) throws IOException {
        ...
        StringBuilder cachedTemplates = new StringBuilder().append("\n");
